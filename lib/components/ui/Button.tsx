...
const variantClassNames: Record<Variant, string> = {
  ...
  alternative:
    "py-2.5 px-5 text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700",
...
const CommonButton: React.FC<CommonButtonProps> = ({
  ...
  const className = `inline-flex justify-center items-center focus:outline-none text-sm font-medium rounded-lg px-5 py-2 ${variantClassNames[variant]}`;

...
const Breadcrumb = ({ crumbs }: Props) => {
  return (
    <div className="text-center border-b ">
      <div className="md:flex justify-between item-center py-4 lg:py-8 bg-white rounded-2xl dark:bg-neutral-800">
        <h1
          itemProp="headline"
          className="text-xl lg:text-3xl font-bold text-center mb-4"
